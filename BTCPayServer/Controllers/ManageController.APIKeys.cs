...
namespace BTCPayServer.Controllers
{
    public partial class ManageController
    {
        ...
        /// <param name="redirect">The URl to redirect to after the user consents, with the query parameters appended to it: permissions, user-id, api-key. If not specified, user is redirect to their API Key list.</param>
        ...
        [SwaggerResponse(StatusCodes.Status307TemporaryRedirect, null,
            Description =
                "Redirects to the specified url with query string values for api-key, permissions, and user-id")]
